...
- Use `v.take()` when iterating over arrays or mapping values inside an object to transfer ownership down to the recursive function, and also inside hot loops parsing JSON strings.
